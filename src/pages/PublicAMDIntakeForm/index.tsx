...
const PublicAMDIntakeForm = () => {
  ...
  const createAmdForm = useCreateAmdIntakeForm({ close: () => null });
  ...
  const onSubmit = () => {
    ...
    navigate(ROUTES.END_SESSION_CONFIRMATION.navigatePath(appointmentId), {
  ...
  return (
    <div className='bg-white rounded-20px border border-solid border-surface p-5 container  mx-auto mt-10 '>
...
export default PublicAMDIntakeForm;
