import type { Role, RolesColumnsProps } from '@/features/admin/components/RolePermission/type';
          ...
          content={() => (
            <ul className='flex flex-col min-w-32'>
              <li
                ...
                onClick={() => onView(row.original)} // ✅ lowercase
              >
              ...
              >
                <div className='w-5'>{<Icon name='delete' className='w-4 h-4 icon-wrapper' />}</div>
